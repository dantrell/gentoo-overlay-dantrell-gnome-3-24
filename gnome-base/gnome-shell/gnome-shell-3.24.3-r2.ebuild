...
IUSE="+bluetooth browser-extension deprecated-background elogind +ibus +networkmanager nsplugin systemd vanilla-gc vanilla-motd vanilla-screen"
...
COMMON_DEPEND="
	...
	x11-libs/libXtst
	>=x11-wm/mutter-3.24.0[deprecated-background=,introspection]
